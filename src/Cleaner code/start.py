...
# Seems unused, might be useful (is it just background_update_layout but better?)
...
def background_update_layout():
    global input
    print("In Background Update Layout func")
    ...
    while True:
        ...
        for i in res:
            ...
            if(student_id in all_studentids):
                item={"date":date_time,"student_id":student_id,"action":action,"problem_log_id":problem_log_id,"assignment_id":assignment_id,"correct":correct}
                data.append(item)
